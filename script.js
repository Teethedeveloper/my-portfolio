...
function Navbar() {
  ...
  return /*#__PURE__*/(
    ...
    React.createElement("div", { className: `collapse navbar-collapse ${isNavbarOpen ? 'show' : ''}`, id: "navbarNav" }, /*#__PURE__*/
    React.createElement("ul", { className: "navbar-nav ms-auto" }, /*#__PURE__*/
    React.createElement("li", { className: "nav-item" }, /*#__PURE__*/
    React.createElement("a", { className: "nav-link", href: "#home" }, "Home")), /*#__PURE__*/

    React.createElement("li", { className: "nav-item" }, /*#__PURE__*/
    React.createElement("a", { className: "nav-link", href: "#about" }, "About")), /*#__PURE__*/

    React.createElement("li", { className: "nav-item" }, /*#__PURE__*/
    React.createElement("a", { className: "nav-link", href: "#projects" }, "Projects")), /*#__PURE__*/
...
function About() {
  return /*#__PURE__*/(
    React.createElement("section", { id: "about", className: "py-5 bg-light" }, /*#__PURE__*/
    React.createElement("div", { className: "container" }, /*#__PURE__*/
    React.createElement("h2", { className: "text-center mb-4" }, "About Me"), /*#__PURE__*/
    ...
    React.createElement("img", { src: "https://res.cloudinary.com/dkv5wtwtd/image/upload/v1742222928/IMG_6157_b54k6n.jpg",
      alt: "A portrait of the developer",
      className: "img-fluid rounded-circle", style: { height: '160px', width: "160px", objectFit: 'cover' } })), /*#__PURE__*/
    ...
    React.createElement("div", { className: "about-text" }, /*#__PURE__*/
...
function Projects() {
...

  {
    ...
    description:
    'Built with React and JavaScript. This project implements a Pomodoro timer that helps users manage their work and break intervals efficiently. It includes a customizable session and break length, and it alerts users with a beep when the timer ends.',
  ...
  return /*#__PURE__*/(
    ...
    React.createElement("a", { href: project.link, className: "btn btn-outline-primary view-project" }, "View Project")))))))));
...
function ContactForm() {
  ...
  return /*#__PURE__*/(
    React.createElement("section", { id: "contact", className: "py-5 bg-light" }, /*#__PURE__*/
    React.createElement("div", { className: "container" }, /*#__PURE__*/
    ...
    React.createElement("input", {
      ...
      required: true,
      placeholder: "Your Name" })), /*#__PURE__*/
    ...
    React.createElement("div", { className: "alert alert-danger fade show", role: "alert" }, "\u274C Please check your email and ensure your message is not empty.")), /*#__PURE__*/
    ...
    React.createElement("ul", { className: "list-unstyled d-flex justify-content-center" }, /*#__PURE__*/
    React.createElement("li", { className: "mx-3" }, /*#__PURE__*/
    ...
    React.createElement("i", { className: "fas fa-phone fa-2x" }))), /*#__PURE__*/


    React.createElement("li", { className: "mx-3" }, /*#__PURE__*/
    React.createElement("a", { href: "mailto:eleton@gmail.com" }, /*#__PURE__*/
    React.createElement("i", { className: "fas fa-envelope fa-2x" }))))))));
...
function App() {
  useEffect(() => {
    ...
    const update = () => scrollSpy.refresh();
